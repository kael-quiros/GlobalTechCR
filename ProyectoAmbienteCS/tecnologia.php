...
<body>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
    ...
    <div class="row text-center py-5">
        ...
        $query = "SELECT id, product_name, product_price, product_image, product_description FROM productos WHERE id_categoria = 1";
                    ...
                    <form action="shoppingCart.php" method="post">
                        <div>
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="page" value="tecnologia"> <!-- Cambia "hogar" por el nombre de la página actual -->
